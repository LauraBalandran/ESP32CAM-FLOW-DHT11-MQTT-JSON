/*
 * Envío de datos del sensor DHT11 por MQTT
 * por: Hugo Escalpelo
 * Fecha: 28 de julio de 2021
 * Actualizado por: Laura del Rocio Balandrán C.
 * Fecha: 22/agosto/022
 * 
 * Este programa realiza la lectura del sensor DHT11 con ayuda de la bliblioteca
 * AdaFruit y envía la temperatura y humedad relativa por MQTT en un JSON.
 * Este programa esta basado en los programas MQTT Basic y JSON Basic del repositorio
 * del CodigoIoT.
 * 
...
void loop() {
 ...
 // Las lecturas del sensor también pueden tener hasta 2 segundos de antigüedad (es un sensor muy lento)
  ...
  //Secuencia que se asegura de que la conexión con el sensor exista
    ...
    String json = "{\"id\":\"Laura\",\"temp\":"+String(t)+",\"hum\":"+String(h)+"}";
